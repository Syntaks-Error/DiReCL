...
class HopperEnv(MujocoEnv):
    """MuJoCo Hopper-v4 environment with oracle reward details intentionally omitted.
    ...
    ### Description
    The Hopper-v4 is a two-dimensional one-legged figure that consist of four main body parts - the torso at the top, the thigh in the middle, the leg in the bottom, and a single foot on which the entire body rests. The goal is to make hops that move in the
    forward (right) direction by applying torques on the three hinges connecting the four body parts.
